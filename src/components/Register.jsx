      ...
      <div className="bg-green-200">
        ...
        <div className="mt-10 sm:mt-0">
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                <h3 className="text-lg font-medium leading-6 text-gray-900">Informação Pessoal</h3>
                <p className="mt-1 text-sm text-gray-600">Use um endereço permanente onde você possa receber e-mails.</p>
              </div>
            </div>
            <div className="mt-5 md:col-span-2 md:mt-0">
              <form action="#" method="POST">
          ...
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                ...
                <p className="mt-1 text-sm text-gray-600">Decida quais comunicações você gostaria de receber e como.</p>
              </div>
            </div>
            <div className="mt-5 md:col-span-2 md:mt-0">
              <form action="#" method="POST">
                <div className="overflow-hidden shadow sm:rounded-md">
                  <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                    ...
                    <fieldset>
                      <legend className="contents text-base font-medium text-gray-900">Notificações via telemóvel</legend>
                      <p className="text-sm text-gray-500">Estes são entregues via SMS para o seu telemóvel.</p>
                      <div className="mt-4 space-y-4">
